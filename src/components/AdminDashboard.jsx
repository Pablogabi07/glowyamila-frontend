  ...
  return (
    <div className="admin-container">
      ...
      <div className="dashboard-cards">
        <div className="dash-card"><h3>{stats.total}</h3><p>Productos totales</p></div>
        <div className="dash-card"><h3>{stats.offers}</h3><p>En oferta</p></div>
        <div className="dash-card"><h3>{stats.categories}</h3><p>Categorías únicas</p></div>
        <div className="dash-card"><h3>${stats.avgPrice}</h3><p>Precio promedio</p></div>
        <div className="dash-card"><h3>${stats.maxPrice}</h3><p>Producto más caro</p></div>
        <div className="dash-card"><h3>${stats.minPrice}</h3><p>Producto más barato</p></div>
        <div className="dash-card warning"><h3>{stats.lowStock}</h3><p>Stock bajo (≤ 5)</p></div>
        <div className="dash-card danger"><h3>{stats.outOfStock}</h3><p>Sin stock</p></div>
      </div>
